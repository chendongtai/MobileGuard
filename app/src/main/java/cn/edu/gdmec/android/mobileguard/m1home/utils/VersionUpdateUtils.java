...
public class VersionUpdateUtils {
    ...
    public VersionUpdateUtils(String mVersion, Activity context,
                              DownloadCallback downloadCallback, Class<?> nextActivty) {
    ...
    public void getCloudVersion(String url){
        try{
            ...
            if (execute.getStatusLine().getStatusCode()==200){
                ...
                versionEntity.versionCode = jsonObject.getString
                        ("code");
                versionEntity.description = jsonObject.getString
                        ("des");
                versionEntity.apkurl = jsonObject.getString
                        ("apkurl");
    ...
    private void showUpdateDialog(final VersionEntity
                                          versionEntity){
        ...
        builder.setPositiveButton("立刻升级",new
        ...
        builder.setNegativeButton("暂不升级",new
                DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialogInterface,int
                            i){
    ...
    public void downapk(String url, String targetFile, Context
            context) {
        //创建下载任务
